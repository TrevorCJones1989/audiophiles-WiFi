...
**
** Created: Fri Dec 2 08:55:11 2011
...
static const char qt_meta_stringdata_AudioStream[] = {
    "AudioStream\0"
};

const QMetaObject AudioStream::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_AudioStream,
      qt_meta_data_AudioStream, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &AudioStream::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AudioStream))
